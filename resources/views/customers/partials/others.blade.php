<div class="row">
    <div class="col-md-12 mb-2 text-muted small">OTHERS</div>
    ...
    <div class="col-md-12 mb-3">
        ...
        <textarea name="notes" id="notes"
            class="form-control @error('notes') is-invalid @enderror" rows="3">{{ old('notes', isset($customer) ? $customer->notes : '') }}</textarea>
