                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-muted small fw-normal text-center">Total Orders</th>
                            <th class="text-muted small fw-normal text-center">Owed Amount</th>
                            <th class="text-muted small fw-normal text-center">Purchase Amount</th>
                    ...
                    <tbody class="border-top-0">
                        @foreach ($customers as $customer)
                            <tr>
                                ...
                                <td class="align-middle text-center">{{ $customer->owed_amount }}</td>
                                <td class="align-middle text-center">{{ $customer->purchase_amount }}</td>
