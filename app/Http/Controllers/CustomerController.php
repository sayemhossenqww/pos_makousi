...
class CustomerController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return Redirect::back()->with("success", Lang::get("messages.customer_store"));
    }
    ...
    public function update(Request $request, Customer $customer): RedirectResponse
    {
        ...
        return Redirect::back()->with("success", Lang::get("messages.customer_update"));
    }
    ...
    {
        $customer->delete();
        return Redirect::back()->with("success", Lang::get("messages.customer_destroy"));
    }
